...
def main():
    ...
    print(GeneralLedger.htmlify(gl.filter_detail(accounts=accts)))

    # print('')
    # print('Summarized for date range {} to {} and accts {}'.format(beg_date.date(), end_date.date(), accts))
    # print(GeneralLedger.htmlify(gl.sum_by_gl_account(accounts=accts, beginning_date=beg_date, ending_date=end_date)))

    # print('')
    # print('Summarized FS grouping for range {} to {}'.format(beg_date.date(), end_date.date()))
    # print(GeneralLedger.htmlify(gl.sum_by_fs_grouping(beginning_date=beg_date, ending_date=end_date)))
